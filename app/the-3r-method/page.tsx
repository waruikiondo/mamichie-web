    ...
    <div className="bg-brand-tint text-brand-black font-body selection:bg-brand-gold/30 flex-grow flex flex-col">
      ...
      <section className="pt-24 pb-16 px-6 bg-white border-b border-brand-gold/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center justify-center bg-brand-black text-brand-tint px-4 py-1.5 rounded-sm mb-6">
          ...
          <div className="space-y-16 relative before:absolute before:inset-0 before:ml-5 md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-brand-gold/50 before:via-brand-gold/20 before:to-transparent">
            ...
            <div className="relative flex items-start justify-between md:justify-normal w-full group">
              <div className="hidden md:block w-5/12 pr-12 text-right">
                <Microscope className="w-12 h-12 text-brand-gold ml-auto mb-4 opacity-50 group-hover:opacity-100 transition-opacity" />
                <h3 className="font-display text-3xl font-bold uppercase text-brand-tint">Reset</h3>
                <p className="text-[10px] uppercase tracking-widest font-bold text-brand-gold mt-2">Phase 01: Targeted Clinical Audit</p>
              </div>
              <div className="absolute left-0 md:left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-brand-black border-2 border-brand-gold flex items-center justify-center z-10">
                <span className="text-brand-gold font-display font-bold text-lg">1</span>
              </div>
              <div className="w-full pl-16 md:w-5/12 md:pl-12">
                ...
                <p className="text-sm text-brand-tint/80 leading-relaxed font-body text-justify bg-white/5 p-6 rounded-sm border border-brand-gold/10">
            ...
            <div className="relative flex items-start justify-between md:justify-normal w-full group">
              <div className="w-full pl-16 md:w-5/12 md:pr-12 md:pl-0 md:text-right order-2 md:order-1">
                <div className="md:hidden mb-4">
                  <h3 className="font-display text-3xl font-bold uppercase text-brand-tint">Rebalance</h3>
                  <p className="text-[10px] uppercase tracking-widest font-bold text-brand-gold mt-1">Phase 02: Precision Protocols</p>
                </div>
                <p className="text-sm text-brand-tint/80 leading-relaxed font-body text-justify md:text-right bg-white/5 p-6 rounded-sm border border-brand-gold/10">
              ...
              <div className="absolute left-0 md:left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-brand-black border-2 border-brand-gold flex items-center justify-center z-10">
                <span className="text-brand-gold font-display font-bold text-lg">2</span>
              </div>
              <div className="hidden md:block w-5/12 pl-12 order-1 md:order-2 text-left">
                <RefreshCcw className="w-12 h-12 text-brand-gold mb-4 opacity-50 group-hover:opacity-100 transition-opacity" />
                <h3 className="font-display text-3xl font-bold uppercase text-brand-tint">Rebalance</h3>
            ...
            <div className="relative flex items-start justify-between md:justify-normal w-full group">
              <div className="hidden md:block w-5/12 pr-12 text-right">
                <Activity className="w-12 h-12 text-brand-gold ml-auto mb-4 opacity-50 group-hover:opacity-100 transition-opacity" />
                <h3 className="font-display text-3xl font-bold uppercase text-brand-tint">Reclaim</h3>
                <p className="text-[10px] uppercase tracking-widest font-bold text-brand-gold mt-2">Phase 03: Sustainable Autonomy</p>
              </div>
              <div className="absolute left-0 md:left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-brand-black border-2 border-brand-gold flex items-center justify-center z-10">
                <span className="text-brand-gold font-display font-bold text-lg">3</span>
              </div>
              <div className="w-full pl-16 md:w-5/12 md:pl-12">
                <div className="md:hidden mb-4">
                  <h3 className="font-display text-3xl font-bold uppercase text-brand-tint">Reclaim</h3>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto border border-brand-gold/20 p-8 sm:p-12 rounded-sm bg-brand-tint/30 text-center">
